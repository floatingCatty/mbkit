...
from ..operator import models, to_qc_tensors
from ._frontend import normalize_electron_count
...
class DMRGSolver:
    """Direct DMRG solver for symbolic operators and structured integrals."""
    ...
    def solve(self, hamiltonian, *, n_electrons=None, n_particles=None):
        (_, total_electrons) = normalize_electron_count(n_electrons=n_electrons, n_particles=n_particles)
